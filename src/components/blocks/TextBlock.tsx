...
export default function TextBlock({ content, isEditing, onChange }: TextBlockProps) {
  ...
  if (isEditing) {
    return (
      <div className="space-y-2">
        <div className="flex items-center gap-2 text-xs text-sky-600 mb-1">
  ...
  if (!localMarkdown) {
    return <div className="text-sky-400 text-sm italic py-4 text-center">내용이 없습니다. 편집 모드에서 작성해주세요.</div>
  }
